...
app.utils.geocode = function(city, callback, context) {
  var url = 'http://ditu.google.cn/maps/api/geocode/json?sensor=false&address=' + encodeURIComponent(city);
...
app.utils.getNearbyGTFS = function(latlng, callback, context) {  
  var url = 'http://transitmix-wb-vietnam-gtfs.herokuapp.com/api/' +
